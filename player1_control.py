...
def ultimate_down(e):
    return e[0] == "INPUT" and e[1].type == SDL_KEYDOWN and e[1].key == SDLK_r and not e[2] and ultimate_gage >= 1


def up_ultimate_down(e):
    return e[0] == "INPUT" and e[1].type == SDL_KEYDOWN and e[1].key == SDLK_r and e[2] and ultimate_gage >= 3
